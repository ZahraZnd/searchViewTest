package com.example.testsearchfragment.data
...
object DataHelper {
    ...
    private val COLORS_FILE_NAME = "color.json"

    private var sColorWrappers: List<ColorWrapper>? = ArrayList()

    private val sColorSuggestions = ArrayList<ColorSuggestion>(
        listOf(
            ColorSuggestion("green"),
            ColorSuggestion("blue"),
            ColorSuggestion("pink"),
            ColorSuggestion("purple"),
            ColorSuggestion("brown"),
            ColorSuggestion("gray"),
            ColorSuggestion("Granny Smith Apple"),
            ColorSuggestion("Indigo"),
            ColorSuggestion("Periwinkle"),
            ColorSuggestion("Mahogany"),
            ColorSuggestion("Maize"),
            ColorSuggestion("Mahogany"),
            ColorSuggestion("Outer Space"),
            ColorSuggestion("Melon"),
            ColorSuggestion("Yellow"),
            ColorSuggestion("Orange"),
            ColorSuggestion("Red"),
            ColorSuggestion("Orchid")
        )
    )
    ...
    fun findSuggestions(
        ...
        object : Filter() {
            ...
            override fun performFiltering(constraint: CharSequence?): FilterResults {
                ...
                suggestionList.sortWith(Comparator { lhs, rhs -> if (lhs.getIsHistory()) -1 else 0 })
    ...
    private fun deserializeColors(jsonString: String?): List<ColorWrapper>? {
        ...
        val collectionType = object : TypeToken<List<ColorWrapper>>() {
